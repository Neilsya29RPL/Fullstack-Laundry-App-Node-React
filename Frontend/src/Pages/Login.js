                                    ...
                                    <div class="row">
                                        <div class="col-lg-10 col-xl-7 mx-auto">
                                            ...
                                            <form onSubmit={(e) => this.handleLogin(e)}>
                                                ...
                                                <div class="form-group mb-3">
                                                     <input type="password" name="password"  placeholder="Password" value={this.state.password} onChange={this.handleChange} id="typePasswordX" className="form-control rounded-pill border-0 shadow-sm px-4 text-primary" required />
                                                </div>
                                                 <button className="btn btn-dark btn-block text-uppercase mb-2 rounded-pill shadow-sm" type="submit">Login</button>
